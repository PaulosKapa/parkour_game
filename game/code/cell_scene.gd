...
func _on_onoffdown_timeout():
	...
	$lights_roof/onoffdown/Cylinder001.get_surface_material(0).set_emission_energy(1)
...
func _on_onofffinal_timeout():
	...
	$lights_roof/onofffinal/Cylinder001.get_surface_material(0).set_emission_energy(1)
	$lights_roof/onoff/Cylinder001.get_surface_material(0).set_emission_energy(0)
...
func _on_onoff_timeout():
	...
	$lights_roof/onoff/Cylinder001.get_surface_material(0).set_emission_energy(1)
